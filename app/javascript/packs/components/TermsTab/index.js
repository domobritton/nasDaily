      ...
      <div>
        <div className='nd-terms'>
          ...
          <p>
            ...
            intellectual property rights related to it, still belong to Nas Daily Inc..
          </p>
          <p>
            Nas Daily Inc. is committed to ensuring that the app is as useful and efficient as possible.
          ...
          <p>
            The Nas Daily app stores and processes personal data that you have provided to us, in
            order to provide our Service. It’s your responsibility to keep your phone and access
            ...
            could mean that the Nas Daily app won’t work properly or at all.
          </p>
          <p>
            You should be aware that there are certain things that Nas Daily Inc. will not take
            ...
            network provider, but Nas Daily Inc. cannot take responsibility for the app not
          ...
          <p>
            ...
            roaming data charges if you use the app outside of your home territory (i.e.
            region or country) without turning off data roaming. If you are not the bill payer
            for the device on which you’re using the app, please be aware that we assume
            that you have received permission from the bill payer for using the app.
          </p>
          <p>
            Along the same lines, Nas Daily Inc. cannot always take responsibility for the way
            you use the app i.e. You need to make sure that your device stays charged – if
            it runs out of battery and you can’t turn it on to avail the Service, Nas
            Daily Inc. cannot accept responsibility
          </p>
          <p>
            With respect to Nas Daily Inc.’s responsibility for your use of the app, when
            you’re using the app, it’s important to bear in mind that although we endeavour
            ...
            Nas Daily Inc. accepts no liability for any loss, direct or indirect, you
          ...
          <p>
            ...
            on iOS – the requirements for both systems (and for any additional systems
            we decide to extend the availability of the app to) may change, and you’ll
            need to download the updates if you want to keep using the app. Nas Daily Inc.
            ...
            you, We may also wish to stop providing the app, and may terminate use of it at
            any time without giving notice of termination to you. Unless we tell you otherwise,
          ...
          <p>
            ...
            posting the new Terms and Conditions on this page. These changes are effective
